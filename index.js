...
function getNumberFromString(s) {
  ...
  if (isNaN(result)) {
    ...
    return result // Якщо значення є числом, повертаємо його
  } else {
    return 'Error'
  }
}
...
function isNumberFinite(num) {
  let result = isFinite(num) // Використовуємо вбудовану функцію isFinite, щоб перевірити, чи є введене число скінченним.
...
function isValueNaN(value) {
  let result = isNaN(value) // Використовуємо вбудовану функцію isNaN, щоб перевірити, чи є введене значення NaN.
